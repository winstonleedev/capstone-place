...
@dataclass
class Settings:
    grid_width: int = int(os.getenv("PLACE_GRID_WIDTH", "140"))
    grid_height: int = int(os.getenv("PLACE_GRID_HEIGHT", "70"))
    rate_limit_pixels: int = int(os.getenv("PLACE_RATE_LIMIT_PIXELS", "50"))
